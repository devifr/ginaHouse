...
<form action="<?php echo base_url('index.php/admin/pengiriman/insert_data') ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	...
	<th>Alamat Pengiriman</th>
		<td><textarea name="alamat_pengiriman" class="form-textarea"/></textarea></td>
	</tr>
		</tr>
	</tr>
	<tr>
