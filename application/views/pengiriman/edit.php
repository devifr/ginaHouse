...
if($rows->num_rows()>0){
$row = $rows->row(); ?><form action="<?php echo base_url("index.php/admin/pengiriman/update_data/$row->id_pengiriman") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	...
	<td><textarea name="alamat_pengiriman" class="form-textarea"><?php echo $row->alamat_pengiriman; ?></textarea></td>
	</tr>
