...
if($rows->num_rows()>0){
	$row = $rows->row(); 
?>
<form action="<?php echo base_url('index.php/admin/news/update_data/'.$row->id_news) ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<th>Title News :</th>
		<td>
			<input type="text" name="judul_news" class="inp-form" value="<?php echo $row->judul_news; ?>"/>
		</td>
	</tr>
	<tr>
		<th>Description :</th>
		<td><textarea name="deskripsi" class="form-textarea"><?php echo $row->description_news; ?></textarea></td>
	</tr>
	<tr>
		<th>Status :</th>
		<td>
			<select name="status" class="styledselect">
				...
				<option value="0" <?php if($row->status_news=='0') { echo "selected='selected'";} ?>>Non Active</option>
			</select>
		</td>
	</tr>
	<tr>
