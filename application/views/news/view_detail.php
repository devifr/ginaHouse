...
<div id="page-heading"><h1>View Detail News</h1></div>
...
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<th>Title News :</th>
		<td>
			<?php echo $row->judul_news; ?>
		</td>
	</tr>
	<tr>
		<th>Description :</th>
		<td><?php echo $row->description_news; ?></td>
	</tr>
	<tr>
		<th>Date News :</th>
		<td>
			<?php echo $row->date_news; ?>
		</td>
	</tr>
	<tr>
		<th>Status :</th>
		<td>
			<?php if($row->status_news=='0') { echo "Non Active";} else{ echo "Active"; } ?>
		</td>
	</tr>
</table>
<?php }else{
