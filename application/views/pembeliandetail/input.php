...
<form action="<?php echo base_url('index.php/admin/pembeliandetail/insert_data') ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<th>No Transaksi</th>
		<td><input type="text" name="no_transaksi" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Product Id</th>
		<td><input type="text" name="product_id" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Sub Total</th>
		<td><input type="text" name="sub_total" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Quantity</th>
		<td><input type="text" name="quantity" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Costumer Id</th>
		<td><input type="text" name="costumer_id" class="inp-form"/></td>
	</tr>
