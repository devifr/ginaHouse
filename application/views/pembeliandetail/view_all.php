...
<a href="<?php echo base_url('index.php/admin/pembeliandetail/input/'); ?>"><input type="button" value="Add Data" class="form-input" /></a>
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
	<tr>
		...
		<th class="table-header-repeat line-left minwidth-1"><a href="#">Aksi</th>
	</tr>
	...
	<tr>
		...
		<td><a href="<?php echo base_url('index.php/admin/pembeliandetail/edit/'.$kate->id_pembeliandetail); ?>" title="Edit" class="icon-1 info-tooltip"> </a>  
			<a href="<?php echo base_url('index.php/admin/pembeliandetail/delete/'.$kate->id_pembeliandetail); ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Apakah anda Akan Menghapus Record ini?')">  </a>
			<a href="<?php echo base_url('index.php/admin/pembeliandetail/view/'.$kate->id_pembeliandetail); ?>" title="View Detail" class="icon-5 info-tooltip">  </a>
