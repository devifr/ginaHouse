...
if($rows->num_rows()>0){
$row = $rows->row(); 
$alamat = explode('|', $row->alamat_costumer);
?>
<form action="<?php echo base_url("index.php/admin/costumer/update_data/$row->id_costumer") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
	<th>Nama_costumer </th>
	<th><input type="text" name="nama_costumer" value="<?php echo $row->nama_costumer; ?>" class="inp-form"/></th>
	</tr>
	<tr>
		<th>Alamat Costumer</th>
		<td><textarea type="text" name="alamat_costumer" class="form-textarea"/><?php echo $alamat[0]; ?></textarea></td>
	</tr>
		<tr>
		<th>Provinsi</td>
		<td><input type="text" name="provinsi_costumer" class="inp-form" value="<?php echo $alamat[1]; ?>"/></td>
	</tr>
	<tr>
		<th>Kota</td>
		<td><input type="text" name="kota_costumer" class="inp-form" value="<?php echo $alamat[2]; ?>"/></td>
	</tr>
	<tr>
		<th>Kode Pos</td>
		<td><input type="text" name="kdpos_costumer" class="inp-form" value="<?php echo $alamat[3]; ?>"/></td>
	</tr>
	<tr>
		<th>Email Costumer</th>
		<td><input type="text" name="email_costumer"value="<?php echo $row->email_costumer; ?>"  class="inp-form" /></td>
	</tr>
	<tr>
		<th>User Name</th>
		<td><input type="text" name="user_name" value="<?php echo $row->user_name; ?>"  class="inp-form"/></td>
	</tr>
	<tr>
		<th>Password</th>
		<td><input type="password" name="password" value=""  class="inp-form"/> *Fill If Want To Change
			<input type="hidden" name="password2" value="<?php echo $row->password; ?>"  class="inp-form"/></td>	
	</tr>
	</tr>
