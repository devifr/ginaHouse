...
<form action="<?php echo base_url('index.php/admin/costumer/insert_data') ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<th>Nama Costumer</td>
		<td><input type="text" name="nama_costumer" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Alamat Costumer</td>
		<td><input type="text" name="alamat_costumer" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Provinsi</td>
		<td><input type="text" name="provinsi_costumer" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Kota</td>
		<td><input type="text" name="kota_costumer" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Kode Pos</td>
		<td><input type="text" name="kdpos_costumer" class="inp-form"/></td>
	</tr>
	<tr>
		<th>Email Costumer</td>
		<td><input type="text" name="email_costumer" class="inp-form" /></td>
	</tr>
	<tr>
		<th>User Name</td>
		<td><input type="text" name="user_name" class="inp-form" /></td>
	</tr>
	<tr>
		<th>Password</td>
