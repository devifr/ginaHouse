	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<!--  start product-table ..................................................................................... -->
<a href="<?php echo base_url('index.php/admin/kategori/input/'); ?>"><input type="button" value="Add Data" class="form-input" /></a>
<br/>
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
	...
	<?php foreach($kategori->result() as $key => $kate){ ?>
	<tr>
		<td><?php echo $key+1; ?></td>
		<td><?php echo $kate->nama_kategori; ?></td>
		<td><a href="<?php echo base_url('index.php/admin/kategori/edit/'.$kate->id_kategori); ?>" title="Edit" class="icon-1 info-tooltip"> </a>  
			<a href="<?php echo base_url('index.php/admin/kategori/delete/'.$kate->id_kategori); ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Apakah anda Akan Menghapus Record ini?')">  </a>
			<a href="<?php echo base_url('index.php/admin/kategori/view/'.$kate->id_kategori); ?>" title="View Detail" class="icon-5 info-tooltip">  </a>
