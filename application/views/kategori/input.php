...
<div id="page-heading"><h1>Edit Kategori</h1></div>
...
<form action="<?php echo base_url('index.php/admin/kategori/insert_data') ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<th>Nama Kategori :</th>
		<td><input type="text" name="nama_kategori" class="inp-form"/></td>
	</tr>
	<tr>
