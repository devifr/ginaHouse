...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
	<tr>
		...
		<thclass="table-header-repeat line-left minwidth-1"><a href="#">Action</th>
	</tr>
	<?php foreach($product->result() as $kate){ ?>
	<tr>
		<td><?php echo $kate->id_product; ?></td>
		...
		<td><a href="<?php echo base_url('index.php/admin/productr/edit/'.$kate->id_product); ?>" title="Edit" class="icon-1 info-tooltip"> </a>  <a href="<?php echo base_url('index.php/admin/product/delete/'.$kate->id_product); ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Apakah anda Akan Menghapus Record ini?')">  </a></td>
	</tr>
	<?php } ?>
  </table>             
				<!--  end product-table................................... --> 
