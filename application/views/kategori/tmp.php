...
<?php
if($rows->num_rows()>0){
$row = $rows->row(); ?><form action="<?php echo base_url("index.php/admin/pembeliandetail/update_data/$row->id_pembeliandetail") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<td>No Transaksi</td>
		<td><input type="text" name="no_transaksi" value="<?php echo $row->no_transaksi; ?>" class="inp-form"/></td>
	</tr>
	</tr>
	<tr>
		<td>Product Id</td>
		<td><input type="text" name="product_id" value="<?php echo $row->product_id; ?>" class="inp-form"/></td>
	</tr>
	</tr>
	<tr>
		<td>Sub Total</td>
		<td><input type="text" name="sub_total" value="<?php echo $row->sub_total; ?>" class="inp-form"/></td>
	</tr>
	<tr>
		<td>quantity</td>
		<td><input type="text" name="quantity" value="<?php echo $row->quantity; ?>" class="inp-form"/></td>
	</tr>
	<tr>
		<td>Costumer Id</td>
		<td><input type="text" name="costumer_id" value="<?php echo $row->costumer_id; ?>" class="inp-form"/></td>
	</tr>
