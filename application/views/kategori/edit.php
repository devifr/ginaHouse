...
<div id="page-heading"><h1>Add Kategori</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Add Kategori details</a></div>
			<div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">2</div>
			<div class="step-light-left">Select related kategori</div>
...
<?php
if($rows->num_rows()>0){
$row = $rows->row(); ?><form action="<?php echo base_url("index.php/admin/kategori/update_data/$row->id_kategori") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
	<th>Nama_Kategori </th>
	<td><input type="text" name="nama_kategori" value="<?php echo $row->nama_kategori; ?>" class="inp-form"/></td>
	</tr>
	</tr>
