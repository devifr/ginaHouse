...
<?php
if($rows->num_rows()>0){
$row = $rows->row(); ?><form action="<?php echo base_url("index.php/admin/login_admin/update_data/$row->id_admin") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
	<td>User Name </td>
	<td><input type="text" name="username_admin" value="<?php echo $row->username_admin; ?>" class="inp-form"/></td>
	</tr>
	<tr>
		<td>Nama Admin</td>
		<td><input type="text" name="nama_admin" value="<?php echo $row->nama_admin; ?>" class="inp-form"/></td>
	</tr>
	<tr>
		<td>Password Admin</td>
		<td><input type="password" name="password_admin" value=""  class="inp-form" /></td>
	</tr>
	<tr>
		<td>Email Admin</td>
		<td><input type="text" name="email_admin" value="<?php echo $row->email_admin; ?>"  class="inp-form"/></td>
	</tr>
	<tr>
