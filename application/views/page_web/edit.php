...
<div id="page-heading"><h1>Edit Page Web</h1></div>
...
if($rows->num_rows()>0){
	$row = $rows->row(); 
?>
<form action="<?php echo base_url('index.php/admin/page_web/update_data/'.$row->id_page) ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
		<th>Title Page :</th>
		<td>
			<input type="text" name="judul_page" class="inp-form" value="<?php echo $row->judul_page; ?>"/>
		</td>
	</tr>
	<tr>
		<th>Description :</th>
		<td><textarea name="deskripsi" class="form-textarea"><?php echo $row->deskripsi_page; ?></textarea></td>
	</tr>
	<tr>
		<th>Status :</th>
		<td>
			<select name="status" class="styledselect">
				<option value="1">Active</option>
				<option value="0" <?php if($row->status_page=='0') { echo "selected='selected'";} ?>>Non Active</option>
			</select>
		</td>
	</tr>
	<tr>
