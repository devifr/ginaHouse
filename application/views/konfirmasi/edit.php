...
$row = $rows->row(); ?>
<form action="<?php echo base_url("index.php/admin/konfirmasi/update_data/$row->id_konfirmasi") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
	<th>No Transaksi </th>
	<th><input type="text" name="no_transaksi" value="<?php echo $row->no_transaksi; ?>" class="inp-form"/></th>
	</tr>
	<tr>
		<th>Costumer id</th>
		<th><input type="text" name="costumer_id" value="<?php echo $row->costumer_id; ?>" class="inp-form"/></th>
	</tr>
	<tr>
		<th>Nama Bank</th>
		<th><input type="text" name="nama_bank"value="<?php echo $row->nama_bank; ?>" class="inp-form"/></th>
	</tr>
	<tr>
		<th>No Rekening</th>
		<th><input type="text" name="no_rekening" value="<?php echo $row->no_rekening; ?>" class="inp-form"/></th>
	</tr>
	<tr>
	<th colspan="2"><input type="submit" name="simpan" value="Simpan" class="form-submit"/></th>
	</tr>
	</table>
	</form>
	<?php }else{
