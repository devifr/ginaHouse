...
<form action="<?php echo base_url('index.php/admin/konfirmasi/insert_data') ?>" method="post" name="form_input">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	...
	<tr>
		<td>Nama Bank</td>
		<td><input type="text" name="nama_bank" class="inp-form"/></td>
	</tr>
	<tr>
		<td>No Rekening</td>
		<td><input type="text" name="no_rekening" class="inp-form"/></td>
	</tr>
	<tr>
