...
<a href="<?php echo base_url('index.php/admin/pembelian/input/'); ?>"><input type="button" value="Add Data" class="form-input" /></a>
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
	<tr>
		<th class="table-header-repeat line-left minwidth-1"><a href>No</th>
		<th class="table-header-repeat line-left minwidth-1"><a href>Total</th>
	...
	<?php foreach($pembelian->result() as $kate){ ?>
	<tr>
		<td><?php echo $kate->id_pembelian; ?></td>
		<td><?php echo $kate->total; ?></td>
		<td><?php echo $kate->quantity; ?></td>
		<td><?php echo $kate->no_transaksi; ?></td>
<td><a href="<?php echo base_url('index.php/admin/pembelian/edit/'.$kate->id_pembelian); ?>" title="Edit" class="icon-1 info-tooltip"> </a>  
			<a href="<?php echo base_url('index.php/admin/pembelian/delete/'.$kate->id_pembelian); ?>" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Apakah anda Akan Menghapus Record ini?')">  </a>
			<a href="<?php echo base_url('index.php/admin/pembelian/view/'.$kate->id_pembelian); ?>" title="View Detail" class="icon-5 info-tooltip">  </a>
		</td>
	</tr>
	<?php } ?>
  </table>             
