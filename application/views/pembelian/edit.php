...
<?php 
if($rows->num_rows()>0){
$row = $rows->row(); ?><form action="<?php echo base_url("index.php/admin/pembelian/update_data/$row->id_pembelian") ?>" method="post" nama="form_edit">
<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
	<tr>
	<th>total </th>
	<th><input type="text" name="total" value="<?php echo $row->total; ?>" class="inp-form"/></th>
	</tr>
	<tr>
	<th>quantity </th>
	<th><input type="text" name="quantity" value="<?php echo $row->quantity; ?>" class="inp-form"/></th>
	</tr>
	<tr>
	<th>No_transaksi </th>
